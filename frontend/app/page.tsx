  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-rose-50 to-white dark:from-rose-950 dark:to-black">
      ...
      <section className="container mx-auto px-4 py-12 md:py-24 flex flex-col md:flex-row items-center">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-bold text-rose-800 dark:text-rose-200 mb-4">Welcome to NotesApp</h1>
      ...
      {/* Features Section */}
      <section className="bg-rose-50 dark:bg-rose-900 py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-rose-800 dark:text-rose-200 mb-12">Key Features</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {["AI-Powered Analysis", "Mood Tracking", "Secure & Private"].map((feature, index) => (
              ...
              >
                <h3 className="text-xl font-semibold text-rose-600 dark:text-rose-400 mb-2">{feature}</h3>
