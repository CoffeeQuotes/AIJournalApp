...
export default function SetNewPassword({ token }: SetNewPasswordProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const data = await fetchData("/authentication/index.php?action=reset-password", "POST", {
        token,
      ...
      >
        <div className="max-w-md mx-auto">
          ...
          <div className="bg-white dark:bg-zinc-800 rounded-lg shadow-md p-6 md:p-8">
            <h1 className="text-3xl font-bold text-rose-800 dark:text-rose-200 mb-6">Set New Password</h1>
